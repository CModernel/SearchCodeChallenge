...
class GetHorizontalCompactSearchResultsUseCase @Inject constructor(
    ...
    override fun construct(params: Unit): Flow<SearchSectionResult> {
        return mockRequestsRepository.getHorizontalCompactRequestParams()
            .flatMapLatest { request ->
                mockResponsesRepository.getHorizontalCompactSearchResults().map { result ->
