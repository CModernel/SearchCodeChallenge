...
class GetVerticalCompactSearchResultsUseCase @Inject constructor(
    ...
    override fun construct(params: Unit): Flow<SearchSectionResult> {
        return mockRequestsRepository.getVerticalCompactRequestParams()
            .flatMapLatest { request ->
                mockResponsesRepository.getVerticalCompactSearchResults().map { result ->
